          ...
          <div class="picker-wrap">
            <table class="date-picker">
              <thead>
                ...
                <tr class="date-days">
                  <th v-for="day in days" :key="day" v-if="selected == 'Month'">
                    {{ day }}
                  </th>
                    ...
                    <div
                      ...
                      v-if="
                        date[i * 7 + j] &&
                          ...
                          date[i * 7 + j] &&
                          date[i * 7 + j].time.getDate() ==
                            item.time_at.getDate()
                      "
                      class="item"
                    >
                    ...
                    <div class="r">
                      ...
                      <div class="c_md_11">
                        <div
                          ...
                          :key="item.id"
                          v-if="
                            now.getFullYear() == item.time_at.getFullYear() &&
                              now.getMonth() == item.time_at.getMonth() &&
                              now.getDate() == item.time_at.getDate() &&
                              item.time_at.getHours() == i
                          "
                        >
                          {{ formatAMPM(item.time_at) + "-" + item.title }}
                        </div>
