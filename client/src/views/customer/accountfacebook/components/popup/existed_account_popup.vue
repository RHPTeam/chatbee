<template>
  <div class="modal--wrapper">
    <div class="modal--dialog d_flex justify_content_center align_items_center">
      <div class="modal--content position_relative" v-click-outside="closeAddPopup">
        <div class="modal--body mt_4">
          <div class="error--title">Tài khoản Facebook đã tồn tại</div>
          <div class="error--desc mt_2 mb_4">
            Chúng tôi nhận thấy tài khoản Facebook của bạn đã được thêm vào hệ thống. 
            Hãy chắc chắn rằng bạn đã thêm đúng tài khoản của mình và chưa sử dụng nó trong bất kì tài khoản Zinbee nào.
          </div>
        </div>
